                ...
                <div class="col-12">
                    <div class="row justify-content-center gap-4">
                        ...
                        <div class="col-3 shadow mt-3 text-center">
                            <a href="studentRegistration.php" class="fw-bold fs-5 text-success">Add New Student</a>
                        </div>

                        <div class="col-3 shadow mt-3 text-center">
                            <a href="viewAssignmentMarks.php" class="fw-bold fs-5 text-success">View Answer Sheets</a>
                        </div>

                        <div class="col-3 shadow mt-3 text-center">
                            <a href="releaseMarksToStudent.php" class="fw-bold fs-5 text-success">Release Marks</a>
                        </div>

                        <div class="col-3 shadow text-center">
                            <a href="AcademicOfficerUpdateProfile.php" class="fw-bold fs-5 text-success">Update Profile</a>
                        </div>
